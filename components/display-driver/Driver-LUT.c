...
const uint8_t driver_addr_LUT[4] = {
    IS31FL3730_DEFAULT_ADDR + 0x3,
    IS31FL3730_DEFAULT_ADDR + 0x0,
    IS31FL3730_DEFAULT_ADDR + 0x1,
    IS31FL3730_DEFAULT_ADDR + 0x2
};

// **************** LOOK UP TABLE FOR FONTS ******************
// Even digits (2,4,6) have column bit map for each column of 5x7 matrix
const uint8_t ltp_305g_LUT[485] = {
    0x00, 0x00, 0x00, 0x00, 0x00, // (space)  00
    0x00, 0x00, 0x5F, 0x00, 0x00, // !        01
    0x00, 0x07, 0x00, 0x07, 0x00, // "        02
    0x7F, 0x7F, 0x7F, 0x7F, 0x7F, // #        03
